...
def get_compound_info_from_chembl_apm_assays(pchembl_active_threshold: float = 6, compound_id_col: str = 'InChIKey_simp', update: bool = False,
    ...
    if update:
        ...
        df = pd.read_csv(assay_csv, index_col=0)
    return df
